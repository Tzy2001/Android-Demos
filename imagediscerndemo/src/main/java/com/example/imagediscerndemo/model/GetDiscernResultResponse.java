package com.example.imagediscerndemo.model;

import java.util.List;

/**
 * @ClassName GetDiscernResultResponse
 * @Author TZY
 * @Date 2024/1/30 20:30
 **/
public class GetDiscernResultResponse {//获取识别结果响应实体
    /**
    ...
    public static class ResultBean {
        ...
        private String root;
        private List<BaikeInfoBean> baike_info;
        ...
        public List<BaikeInfoBean> getBaike_info() {
            return baike_info;
        }

        public void setBaike_info(List<BaikeInfoBean> baike_info) {
